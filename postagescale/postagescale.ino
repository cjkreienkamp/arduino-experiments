/*
  ...
  This example shows how to set up a scale complete with zero offset (tare),
...
//modified to output numerical values only to Serial Plotter and HC-06 Bluetooth radio on software serial pins
...
mySerial.println(currentWeight);
...
void calibrateScale(void)
{
  ...
  Serial.println(F("Set up scale with no weight on it. Press a key when ready."));
